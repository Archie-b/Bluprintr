namespace Bluprintr.Controllers
{
    ...
    public class BlueprintController : Controller
    {
        ...
        {
            value.Components.ForEach(delegate (Component c) { c.Id = ObjectId.GenerateNewId().ToString(); });
            return new Response(JsonConvert.SerializeObject(this.dBInterface.Post(value)));
        }
